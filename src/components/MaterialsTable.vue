		...
		<div class="shadow-2xl rounded-2xl shadow-primary-200">
			<div class="m-4">
				<div class="sm:hidden">
					...
					<select @change="calcStore.changeMaterial()" id="tabs" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
				...
				<ul class="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex">
					<li class="w-full focus-within:z-10">
						<button
							...
							:class="[calcStore.material_type == 'aluminium' ? 'text-black bg-yellow-300 active font-bold' : 'bg-white hover:text-gray-700 hover:bg-primary-100']"
						>
							Алюминиевый
						</button>
					</li>
					<li class="w-full focus-within:z-10">
						<button
							...
							:class="[calcStore.material_type == 'polycarbonate' ? 'text-black bg-yellow-300 active font-bold' : 'bg-white hover:text-gray-700 hover:bg-primary-100']"
						>
							Поликарбонат
						</button>
					</li>
