    ...
    >
      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1
            class="text-xl text-center font-bold leading-tight tracking-tight text-black md:text-2xl dark:text-white"
          >
            Вход
          </h1>
          <form
          ...
          >
            ...
            <ButtonTag type="submit" class="w-full">{{
